import { User, Shield, Mail, MapPin, Music, Camera, ChevronRight, Settings, LogOut, Award, Clock, Heart } from 'lucide-react';
...
export default function ProfileView({ onBack, onViewChange }: ProfileViewProps) {
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="px-6 py-8 max-w-2xl mx-auto space-y-8">
        ...
        <section className="space-y-2">
          ...
          <button className="w-full flex items-center justify-between p-4 bg-surface-container-high rounded-2xl border border-outline-variant/5 hover:bg-surface-bright transition-colors text-error">
            <div className="flex items-center gap-4">
